...
class NodeResource extends Resource
{
    ...
    *
    * @return \Psr\Http\Message\ResponseInterface|\DockerPhpClient\Model\Node[]|\DockerPhpClient\Model\ErrorResponse
    */
    public function nodeList($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'DockerPhpClient\\Model\\Node[]', 'json');
            }
     ...
     * @param \DockerPhpClient\Model\NodeSpec $body 
     * @param array  $parameters {
     ...
     * @return \Psr\Http\Message\ResponseInterface|null|\DockerPhpClient\Model\ErrorResponse
     */
    public function nodeUpdate($id, \DockerPhpClient\Model\NodeSpec $body, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        $queryParam->setRequired('version');
        $url = '/v1.31/nodes/{id}/update';
        $url = str_replace('{id}', urlencode($id), $url);
        $url = $url . ('?' . $queryParam->buildQueryString($parameters));
        $headers = array_merge(array('Host' => 'localhost'), $queryParam->buildHeaders($parameters));
