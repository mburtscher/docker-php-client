...
class MountVolumeOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'DockerPhpClient\\Model\\MountVolumeOptions') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \DockerPhpClient\Model\MountVolumeOptions) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DockerPhpClient\Model\MountVolumeOptions();
        ...
        if (property_exists($data, 'DriverConfig')) {
            $object->setDriverConfig($this->denormalizer->denormalize($data->{'DriverConfig'}, 'DockerPhpClient\\Model\\MountVolumeOptionsDriverConfig', 'json', $context));
        }
        return $object;
    }
