...
class PluginConfigUserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'DockerPhpClient\\Model\\PluginConfigUser') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \DockerPhpClient\Model\PluginConfigUser) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DockerPhpClient\Model\PluginConfigUser();
