...
class SwarmResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'DockerPhpClient\\Model\\SwarmResponse200') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \DockerPhpClient\Model\SwarmResponse200) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DockerPhpClient\Model\SwarmResponse200();
        ...
        if (property_exists($data, 'JoinTokens')) {
            $object->setJoinTokens($this->denormalizer->denormalize($data->{'JoinTokens'}, 'DockerPhpClient\\Model\\SwarmResponse200JoinTokens', 'json', $context));
        }
        return $object;
    }
