...
class HostConfigLogConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'DockerPhpClient\\Model\\HostConfigLogConfig') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \DockerPhpClient\Model\HostConfigLogConfig) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DockerPhpClient\Model\HostConfigLogConfig();
