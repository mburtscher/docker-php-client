...
class ServiceSpecModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'DockerPhpClient\\Model\\ServiceSpecMode') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \DockerPhpClient\Model\ServiceSpecMode) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DockerPhpClient\Model\ServiceSpecMode();
        if (property_exists($data, 'Replicated')) {
            $object->setReplicated($this->denormalizer->denormalize($data->{'Replicated'}, 'DockerPhpClient\\Model\\ServiceSpecModeReplicated', 'json', $context));
        }
