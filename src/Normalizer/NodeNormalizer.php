...
class NodeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'DockerPhpClient\\Model\\Node') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \DockerPhpClient\Model\Node) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \DockerPhpClient\Model\Node();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'DockerPhpClient\\Model\\NodeSpec', 'json', $context));
        }
        if (property_exists($data, 'Description')) {
            $object->setDescription($this->denormalizer->denormalize($data->{'Description'}, 'DockerPhpClient\\Model\\NodeDescription', 'json', $context));
        }
        return $object;
    }
